...
#endif
    public class FirstPersonControllerMulti : NetworkBehaviour
    {
        [Header("Player")]
        ...
        [Networked] public bool Grounded { get; set; } = true;
        ...
        {
            // Only the local player should process camera rotation
            if (HasInputAuthority)
            {
                CameraRotation();
            }
